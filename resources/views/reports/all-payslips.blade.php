...
$data = [
    ...
    'legal_holidays' => $payroll->legal_holidays ?? 0,
    'special_holidays' => $payroll->special_holidays ?? 0,

    'basic_salary' => $payroll->basic_salary ?? 0,
    'gross_pay' => $payroll->gross_pay ?? 0,

    'undertime_hours' => $payroll->undertime_hours ?? 0,
    'undertime_deduction' => $payroll->undertime_deduction ?? 0,

    'overtime_salary' => $payroll->overtime_salary ?? 0,
    'night_diff_salary' => $payroll->night_diff_salary ?? 0,
    'night_diff_ot_salary' => $payroll->night_diff_ot_salary ?? 0,
    'rest_day_ot_salary' => $payroll->rest_day_ot_salary ?? 0,
    'sunday_ot_salary' => $payroll->sunday_ot_salary ?? 0,

    'sss_ee' => $payroll->sss_ee ?? 0,
    'philhealth_ee' => $payroll->philhealth_ee ?? 0,
    'pagibig_ee' => $payroll->pagibig_ee ?? 0,

    'premium_voluntary_ss_contribution' => $payroll->premium_voluntary_ss_contribution ?? 0,

    'sss_salary_loan' => $payroll->sss_salary_loan ?? 0,
    'sss_calamity_loan' => $payroll->sss_calamity_loan ?? 0,
    'pagibig_salary_loan' => $payroll->pagibig_salary_loan ?? 0,
...
<table class="earnings-table">
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($data['overtime_salary'], 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($data['night_diff_salary'], 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($data['night_diff_ot_salary'], 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($data['rest_day_ot_salary'], 2) }}
        </td>
    </tr>
    ...
    <tr>
        <td>Sunday OT Pay</td>
        <td class="right">
            PHP {{ number_format($data['sunday_ot_salary'], 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($other_incentives, 2) }}
        </td>
    </tr>
    ...
    <tr class="bold">
        ...
        <td class="right">
            PHP {{ number_format($final_gross_pay, 2) }}
        </td>
    </tr>
...
<table class="deductions-table">
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($philhealth_ee, 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($pagibig_ee, 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($premium_ss, 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($sss_salary_loan, 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($sss_calamity_loan, 2) }}
        </td>
    </tr>
    ...
    <tr>
        <td>Pag-IBIG Loan</td>
        <td class="right">
            PHP {{ number_format($pagibig_salary_loan, 2) }}
        </td>
    </tr>
    ...
    <tr>
        <td>Cash Advance</td>
        <td class="right">
            PHP {{ number_format($cash_advance, 2) }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="right">
            PHP {{ number_format($other_deduction, 2) }}
        </td>
    </tr>
    ...
    <tr class="bold">
        ...
        <td class="right">
            PHP {{ number_format($total_deductions, 2) }}
        </td>
    </tr>
